...
echo Compiling GMC Test...
nvcc -o compare_gmc.exe compare_gmc.cu -I. -std=c++17 -DCCCL_IGNORE_DEPRECATED_CPP_DIALECT -Xcompiler "/std:c++17" -arch=sm_86
