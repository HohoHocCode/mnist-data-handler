...
#include "imputation_lib/gpu/amvi_impute_gpu.cu"
...
int main() {
  ...
  std::cout << "Loading Evaluation Data for AMVI...\n";
  ...
  // Parameters: MaxK=20 (Search Space)
  std::cout << "Running AMVI Imputation (MaxK=20, Auto-Selection)...\n";
  ...
  impute::amvi_impute_cuda(d_X, d_M, N_FULL, D_FULL, 20);
