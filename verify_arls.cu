...
#include "imputation_lib/gpu/arls_impute_gpu.cu"
...
int main() {
  ...
  std::cout << "Loading Evaluation Data for ARLS...\n";
  ...
  // Parameters: P=10 (AR predictors)
  std::cout << "Running ARLS Imputation (P=10)...\n";
  ...
  impute::arls_impute_cuda(d_X, d_M, N_FULL, D_FULL, 10);
