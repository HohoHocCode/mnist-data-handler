...
// Using the same strategy of including the .cu file for simple verification
// build
...
int main() {
  ...
  std::cout << "Loading Evaluation Data for LinCmb...\n";
  ...
  // Parameters: K=10, Rank=5
  std::cout << "Running LinCmb Imputation (K=10, Rank=5)...\n";
  ...
  impute::lincmb_impute_cuda(d_X, d_M, N_FULL, D_FULL, 10, 5);
  ...
  std::cout << "LinCmb Time: " << duration << " s\n";
