...
echo Compiling ARLS Verification...
nvcc -o verify_arls.exe verify_arls.cu -I. -std=c++17 -DCCCL_IGNORE_DEPRECATED_CPP_DIALECT -Xcompiler "/std:c++17" -arch=sm_86 -lcublas
...
echo Running ARLS Verification...
verify_arls.exe
